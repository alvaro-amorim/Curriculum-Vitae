...
const copy = {
  pt: {
    bootLabel: "Álvaro.dev",
    bootSteps: ["carregando projetos", "conectando stack", "preparando lab", "abrindo portfólio"],
    bootFooter: "portfólio em execução",
    eyebrow: "ÁLVARO AMORIM / FULL STACK",
    title: "Produtos web com IA, dados e interface.",
    subtitle: "Desenvolvo aplicações completas, automações e experiências digitais com foco em entrega real.",
    ...
    operator: "dev",
    imagePending: "Visual em preparação",
    featuredProject: "destaque",
    productStage: "produto",
    liveShowcase: "projetos em destaque",
    connectedStack: "stack",
    activeProject: "em foco",
    ...
    projectsTitle: "Construções reais, não só telas bonitas.",
    projectsIntro: "SaaS, automações, dashboards e experiências com IA — cada projeto com contexto, stack e decisão técnica.",
    projectScene: "produto",
    projectFlow: "fluxo",
    stackEyebrow: "Stack",
    stackTitle: "Tecnologia aplicada ao produto.",
    stackIntro: "React, Next.js, Supabase, APIs e IA usados conforme o problema.",
    stackConnection: "projetos relacionados",
    timelineEyebrow: "Base técnica",
    timelineTitle: "Formação, certificações e prática contínua.",
    timelineIntro: "Uma trilha em evolução, com foco em produto, dados e desenvolvimento web.",
    labEyebrow: "Developer Arcade",
    labTitle: "Jogue o Lab.",
    labIntro: "Mini-games com ranking real para testar lógica, reflexo e debugging.",
    finalTitle: "Vamos construir algo útil?",
    finalSubtitle: "Veja os projetos, abra o currículo ou explore o Lab.",
    directNav: "atalhos",
  ...
  en: {
    bootLabel: "Álvaro.dev",
    bootSteps: ["loading projects", "connecting stack", "preparing lab", "opening portfolio"],
    bootFooter: "portfolio running",
    eyebrow: "ÁLVARO AMORIM / FULL STACK",
    title: "Web products with AI, data and interface.",
    subtitle: "I build full-stack applications, automations and digital experiences focused on real delivery.",
    ...
    operator: "dev",
    imagePending: "Visual in progress",
    featuredProject: "featured",
    productStage: "product",
    liveShowcase: "featured projects",
    connectedStack: "stack",
    activeProject: "in focus",
    ...
    projectsTitle: "Real builds, not just pretty screens.",
    projectsIntro: "SaaS, automations, dashboards and AI experiences — each project with context, stack and technical decisions.",
    projectScene: "product",
    projectFlow: "flow",
    stackEyebrow: "Stack",
    stackTitle: "Technology applied to product.",
    stackIntro: "React, Next.js, Supabase, APIs and AI used according to the problem.",
    stackConnection: "related projects",
    timelineEyebrow: "Technical base",
    timelineTitle: "Education, certifications and continuous practice.",
    timelineIntro: "An evolving track focused on product, data and web development.",
    labEyebrow: "Developer Arcade",
    labTitle: "Play the Lab.",
    labIntro: "Mini-games with real ranking to test logic, reflexes and debugging.",
    finalTitle: "Let’s build something useful?",
    finalSubtitle: "Explore the projects, open the resume or try the Lab.",
    directNav: "shortcuts",
...
const labModules = {
  pt: [
    ["Runtime Runner", "jogável", "Reflexo, erros e score."],
    ["Bug Maze", "jogável", "Debug em formato de labirinto."],
    ["Code Snake", "jogável", "Lógica rápida com tokens e bugs."],
    ["Stack Tetris", "jogável", "Puzzle de stack e módulos."],
  ],
  en: [
    ["Runtime Runner", "playable", "Reflexes, errors and score."],
    ["Bug Maze", "playable", "Debugging as a maze."],
    ["Code Snake", "playable", "Fast logic with tokens and bugs."],
    ["Stack Tetris", "playable", "Stack puzzle with modules."],
  ],
} as const;
...
function NarrativeRail({ locale }: { locale: Locale }) {
  const labels =
    locale === "pt"
      ? ["projetos", "stack", "base", "lab", "contato"]
      : ["projects", "stack", "base", "lab", "contact"];
