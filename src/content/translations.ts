...
export const dictionary: Record<Locale, TranslationTree> = {
  pt: {
    ...
    home: {
      ...
      architectureDescription: "Route Handlers validam sessão, score e ranking com acesso server-side ao Supabase, sem expor credenciais ou identificadores internos no navegador.",
  ...
  en: {
    ...
    home: {
      ...
      architectureDescription: "Route Handlers validate sessions, scores, and rankings through server-side Supabase access without exposing credentials or internal identifiers to the browser.",
